...
__all__ = ['EMOJI_UNICODE', 'UNICODE_EMOJI', 'EMOJI_ALIAS_UNICODE', 'UNICODE_EMOJI_ALIAS', 'sub_script_map', 'sup_script_map']
...
# click.prompt("Enter Your Password")
# sub.call("cd ~ && gnome-terminal -e 'zsh' --geometry=96x16 --zoom 1.1", shell=True)
